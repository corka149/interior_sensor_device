...
def get_config():
    args = sys.argv
    ht_pin = __find_arg__("humidity_and_temp_pin", 4, args)
    md_pin = __find_arg__("movement_detector_pin", 17, args)
    dis = __find_arg__("delay_in_seconds", "5", args)
    ...
    port = __find_arg__("port", 4000, args)
